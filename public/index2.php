...
<html>
    <head>
        <title>CivilTask sistema de Tickets en linea</title>
        <meta charset="utf-8" />
    ...
    <body>
        ...
        <header id="header" class="skel-layers-fixed">
            <h1 id="logo"><a href="index.php">Sistema de Soporte</a></h1>
            <nav id="nav">
                <?php
                if (reconoce('0,1,2')) {
                    include("menu.php");
        ...
        <div id="main" class="wrapper style1">
            <div class="container">
                <header class="major" id="headerXcd33a">
                    <h2>CivilTask</h2>
                    <p>Sistema de tickets virtuales</p>
                </header>
                ...
                <section>
                    <?php if (reconoce('0,1,2')) { ?>
                        ...
                        <script language="javascript" type="text/javascript">
                            $( document ).ready(function() {fn_logear();});
                        </script>
