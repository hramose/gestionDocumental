...
print 'It took ' + i + ' iterations to sort the deck.';
					...
					<!-- Form -->
						<section>
                            ...
                            <input value="<?php echo date("m/d/Y"); ?>"  name="fecha_fin" id="fecha_fin" type="text" data-role="date" />
...
<div data-role="popup" id="popupLogin" class="ui-corner-all" style="background: #000">
    <form>
