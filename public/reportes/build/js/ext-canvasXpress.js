...
Ext.canvasXpress = Ext.extend(Ext.Panel, {
  ...
  showTiles: function() {
    ...
    for(var i = 1; i < this.stackViewObj.stackViews.length; i++)
    {
      ...
      html.push('<td><img src="../../../util/Canvas2231171921154771/build/js/', img[1], '" style="width:' + w + 'px;" /><br><b>' + img[0] + '</b></td>');
    }
...
Ext.canvasXpress.customShapeDialog = Ext.extend(Ext.Window, {
              ...
              },
              {
                ...
                handler: function(b, e) {
                  if(this.extCanvas.customShapesURL)
                  {
                    ...
                    if(dup)
                    {
                      Ext.Msg.alert('Error - Cannot Save Image!!', 'The name of your new image conflict with the name of this image:<br><img style="width:150px;height:100px;" src="../../../util/Canvas2231171921154771/build/js/'+dup.url+'">');
                      return;
                    }
                    if(!text)
                    {
  ...
  getImgHtml: function(id, url, name, editable) {
    var idstr = ' dbid="' + id + '"';
    return '<div style="width:180px;height:150px;text-alignment:center;padding-left:15px;"><img width=150 height=100 src="../../../util/Canvas2231171921154771/build/js/' +
    ...
    this.body.on('click', function(e, t) {
      ...
      if(t.tagName == 'IMG' && p && p.tagName == 'DIV')
      {
        var w = new Ext.Window({
          ...
          html: '<img src="../../../util/Canvas2231171921154771/build/js/'+t.src+'" />'
        });
        w.show();
      }
